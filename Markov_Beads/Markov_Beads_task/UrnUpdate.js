...
var All_Type = ['Low_MMActual','High_MMActual','High_HMMActual','Low_HMMActual']
...
post_trial_gap: 100
	 ...
	 type: 'html-keyboard-response',
	 stimulus: centered_message('<p>Jars are filled with 100% white or black beads, and no beads of the opposite color mixed in.<br><br>Press the SPACEBAR to continue. </p>'),
	 choices: ['spacebar'],
	 prompt: ''
     };
	 ...
	 choices: ['spacebar'],
	 prompt: centered_message_image('A jar filled with 100% White Beads')
     };
	 ...
	 choices: ['spacebar'],
	 prompt: centered_message_image('A jar filled with 100% Black Beads')
     };
    ...
    var Instruction_trial10 = {
	 ...
	 type: 'html-keyboard-response',
	 stimulus: centered_message('<p> As you observed, two white bead was pulled from the 100% white jar one after the other, then the jars switched and a black bead was pulled from the 100% black jar.<br><br>Press SPACEBAR to conitnue.</p>'),
	 choices: ['spacebar'],
	 prompt: ''
     }; 
    ...
    LMM_text = '<p style="font-family:Arial;text-align:center;width:800px;font-size:20px">The probablity that the jar that was previously drawn from is switched to the opposite jar is 32%. <br><br> The jar on the left contains 100% black beads and 0% white beads. <br><br> The jar on the right contains 100% white beads and 0% black beads. <br><br> Press the SPACEBAR to continue.</p>'
	 ...
	 HHMM_text = '<p style="font-family:Arial;text-align:center;width:800px;font-size:20px">In this block, there will be a 99% chance that the jar on the next trial will be different from the jar on the current trial. <br><br> The jar on the left contains 80% black beads and 20% white beads. <br><br> The jar on the right contains 80% white beads and 20% black beads.<br><br> Press the SPACEBAR to continue.</p>'
	     ...
	     HMM_text = '<p style="font-family:Arial;text-align:center;width:800px;font-size:20px">The probablity that the jar that was previously drawn from is switched to the opposite jar is 68%. <br><br> The jar on the left contains 100% black beads and 0% white beads. <br><br> The jar on the right contains 100% white beads and 0% black beads. <br><br> Press the SPACEBAR to continue.</p>'
